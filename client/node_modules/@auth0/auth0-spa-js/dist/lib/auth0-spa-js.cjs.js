...
var Auth0Client = /** @class */ (function () {
    ...
    Auth0Client.prototype.getTokenSilently = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var cache, stateIn, nonceIn, code_verifier, code_challengeBuffer, code_challenge, authorizeOptions, params, url, codeResult, authResult, decodedToken, cacheEntry, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options.scope = getUniqueScopes(this.DEFAULT_SCOPE, options.scope);
                    ...
                    case 8:
                        e_1 = _a.sent();
                        throw e_1;
                    case 9: return [4 /*yield*/, lock.releaseLock(GET_TOKEN_SILENTLY_LOCK_KEY)];
                    case 10:
                        _a.sent();
                        return [7 /*endfinally*/];
